        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            ...
            <ul class="pagination pagination-sm m-0 ml-auto">
                <li class="page-item @if (empty($paginate['meta']['previous'])) disabled @endif">
                    <a class="page-link" href="{{ route('study.index', ['cursor' => $paginate['meta']['previous'], 'search' => request()->search]) }}">
                        &laquo;
                    </a>
                </li>
                <li class="page-item @if (empty($paginate['meta']['next'])) disabled @endif">
                    <a class="page-link" href="{{ route('study.index', ['cursor' => $paginate['meta']['next'], 'search' => request()->search]) }}">
                        &raquo;
                    </a>
                </li>
            </ul>
