...
@section('content')
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Ubah Hadist</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('hadist.update', ['hadist' => $hadist->uuid]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                    ...
                    <div class="col-md-8">
                        <select id="category" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}" required>
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->category }}" @if ($category->category === $hadist->category) selected @endif>{{ $category->category }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $hadist->title) }}" required autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="text" class="form-control @error('text') is-invalid @enderror" name="text" required autocomplete="off">{{ old('text', $hadist->text) }}</textarea>
                        @error('text')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="latin" class="form-control @error('latin') is-invalid @enderror" name="latin" required autocomplete="off">{{ old('latin', $hadist->latin) }}</textarea>
                        @error('latin')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="translation" class="form-control @error('translation') is-invalid @enderror" name="translation" required autocomplete="off">{{ old('translation', $hadist->translation) }}</textarea>
                        @error('translation')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input id="noted" type="text" class="form-control @error('noted') is-invalid @enderror" name="noted" value="{{ old('noted', $hadist->noted) }}" required autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input id="source" type="text" class="form-control @error('source') is-invalid @enderror" name="source" value="{{ old('source', $hadist->source) }}" required autocomplete="off">
