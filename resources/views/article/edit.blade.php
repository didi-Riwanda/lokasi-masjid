...
@section('content')
    <div class="card card-info">
        ...
        <div class="card-body">
            <form action="{{ route('article.update', ['article' => $article->uuid]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $article->title) }}" required autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="body" type="text" class="form-control @error('body') is-invalid @enderror" name="body" autocomplete="off">{{ old('body', $article->content) }}</textarea>
