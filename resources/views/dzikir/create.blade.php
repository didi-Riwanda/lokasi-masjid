...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Tambah Dzikir</li>
    </ol>
@endsection
...
@section('content')
    <div class="card card-info">
        ...
        <div class="card-body">
            <form action="{{ route('dzikir.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="arabic" class="form-control @error('arabic') is-invalid @enderror" name="arabic" value="{{ old('arabic') }}" required autocomplete="off"></textarea>
                        @error('arabic')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input id="notes" type="text" class="form-control @error('notes') is-invalid @enderror" name="notes" value="{{ old('notes') }}" required autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <textarea id="fawaid" class="form-control @error('fawaid') is-invalid @enderror" name="fawaid" value="{{ old('fawaid') }}" required autocomplete="off"></textarea>
                        @error('fawaid')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
